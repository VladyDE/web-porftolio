...
export const copy = {
  es: {
    ...
    aboutHighlights: [
      ['01 / EFICIENCIA', '-80%', 'Tiempo operativo', 'Optimización de cargas y borrados masivos.'],
      ['02 / CLOUD', '03', 'certificaciones cloud', 'Formación validada en plataformas líderes.'],
      ['03 / MÉTODO', 'TDD', 'pruebas antes del código', 'Desarrollo guiado por pruebas desde el primer commit.'],
      ['04 / INTEGRIDAD', 'DATA', 'calidad que inspira confianza', 'Calidad y confiabilidad en cada dato procesado.'],
    ],
  ...
  en: {
    ...
    aboutHighlights: [
      ['01 / EFFICIENCY', '-80%', 'Operational time', 'Optimized bulk data loading and deletion workflows.'],
      ['02 / CLOUD', '03', 'cloud certifications', 'Validated expertise across leading cloud platforms.'],
      ['03 / METHOD', 'TDD', 'tests before code', 'Test-driven development from the first commit.'],
      ['04 / INTEGRITY', 'DATA', 'quality you can trust', 'Data quality and reliability in every process.'],
    ],
